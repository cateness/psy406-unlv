...
This dataset contains measurements from `r nrow(penguins)` different penguins. Measurements include things like bill length and depth, flipper length, and sex, among others.
