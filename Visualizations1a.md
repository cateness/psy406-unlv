...
In looking at the graph created in the last section (shown above; I've removed the trendline for now), it kind of seems like there may be different groups or clusters of penguins in this data. When you notice a pattern like this, it is worth looking into further and considering what variables you have in our data that could be related.
...
Now that we've looked into color, let's try adding our trendline back in with the `geom_smooth()` function.
