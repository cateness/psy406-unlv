...
```{r Logical Operators, echo=FALSE, message=T, warning=T}
library(tidyverse)
kableExtra::kbl(data.frame("Operator" = c("<code>&amp;</code>", 
                              "<code>&vert;</code>", 
                              "<code>!</code>", 
                              "<code>%in%</code>"),
                           "Description" = c("And", 
                ...
                align = "c",
                format = "html",
                escape = FALSE) %>% # Added to prevent kable from altering your HTML entities)
    kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed", "bordered"), full_width = F, position = "center")
```
